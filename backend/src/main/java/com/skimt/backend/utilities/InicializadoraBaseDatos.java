...
public class InicializadoraBaseDatos {
    ...
    public static void insertarDatosPrueba(String nombreBD) {
        ...
        String sql = "INSERT INTO juego (descripcion, foto_larga, nombre, portada, precio, video, categoria) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?)";

        try (Connection con = DriverManager.getConnection(url, usuario, contrasena)) {

        	String checkEmptyTableQuery = "SELECT COUNT(*) FROM juego";
            try (Statement stmtCheck = con.createStatement()) {
                ResultSet rs = stmtCheck.executeQuery(checkEmptyTableQuery);
                if (rs.next() && rs.getInt(1) > 0) {
                    // Si la tabla no está vacía, no insertamos
                    System.out.println("La tabla ya tiene datos. No se insertarán datos de prueba.");
                    return;
                }
            }
            ...
            try (PreparedStatement stmt = con.prepareStatement(sql)) {
                ...
                stmt.setString(2, "/imagenes/arma3Grande.jpg");
                stmt.setString(3, "Arma 3");
                stmt.setString(4, "/imagenes/arma3Pequeno.jpg");
                stmt.setDouble(5, 2799);
                stmt.setString(6, "https://www.youtube.com/embed/M1YBZUxMX8g");
                stmt.setString(7, "Estrategia");
                stmt.executeUpdate();
                ...
                stmt.setString(2, "/imagenes/assetoGrande.jpg");
                stmt.setString(3, "Assetto Corsa");
                stmt.setString(4, "/imagenes/assetoPequeno.jpg");
                stmt.setDouble(5, 1999);
                stmt.setString(6, "https://www.youtube.com/embed/CYncAnd31Q8");
                stmt.setString(7, "Carreras");
                stmt.executeUpdate();
                ...
                stmt.setString(2, "/imagenes/bioshockGrande.jpg");
                stmt.setString(3, "Bioshock");
                stmt.setString(4, "/imagenes/bioshockPequeno.jpg");
                stmt.setDouble(5, 1999);
                stmt.setString(6, "https://www.youtube.com/embed/CoYorK3E4aM");
                stmt.setString(7, "Acción");
                stmt.executeUpdate();
                ...
                stmt.setString(2, "/imagenes/blackOps2Grande.jpg");
                stmt.setString(3, "Call of Duty: Black Ops II");
                stmt.setString(4, "/imagenes/blackOps2Pequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/cyberpunkGrande.jpg");
                stmt.setString(3, "Cyberpunk 2077");
                stmt.setString(4, "/imagenes/cyberpunkPequeno.jpg");
                stmt.setDouble(5, 5999);
                stmt.setString(6, "https://www.youtube.com/embed/5c7rAU5UmWY");
                stmt.setString(7, "RPG");
                stmt.executeUpdate();
                ...
                stmt.setString(2, "/imagenes/darkSoulsGrande.jpg");
                stmt.setString(3, "Dark Souls III");
                stmt.setString(4, "/imagenes/darkSoulsPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/deadSpaceGrande.jpg");
                stmt.setString(3, "Dead Space");
                stmt.setString(4, "/imagenes/deadSpacePequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/doomGrande.jpg");
                stmt.setString(3, "Doom");
                stmt.setString(4, "/imagenes/doomPequeno.jpg");
                stmt.setDouble(5, 1999);
                ...
                stmt.setString(2, "/imagenes/eldenRingGrande.jpg");
                stmt.setString(3, "Elden Ring");
                stmt.setString(4, "/imagenes/eldenRingPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/falloutGrande.jpg");
                stmt.setString(3, "Fallout: New Vegas");
                stmt.setString(4, "/imagenes/falloutPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/fifaGrande.jpg");
                stmt.setString(3, "Fifa 2025");
                stmt.setString(4, "/imagenes/fifaPequeno.jpg");
                stmt.setDouble(5, 4999);
                stmt.setString(6, "https://www.youtube.com/embed/pBM2xyco_Kg");
                stmt.setString(7, "Deportes");
                stmt.executeUpdate();
                ...
                stmt.setString(2, "/imagenes/forza5Grande.jpg");
                stmt.setString(3, "Forza Horizon 5");
                stmt.setString(4, "/imagenes/forza5Pequeno.jpg");
                stmt.setDouble(5, 5999);
                ...
                stmt.setString(2, "/imagenes/godOfWarGrande.jpg");
                stmt.setString(3, "God of War: Ragnarok");
                stmt.setString(4, "/imagenes/godOfWarPequeno.jpg");
                stmt.setDouble(5, 5999);
                ...
                stmt.setString(2, "/imagenes/gtaGrande.jpg");
                stmt.setString(3, "Grand Theft Auto V");
                stmt.setString(4, "/imagenes/gtaPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/helldiverGrande.jpg");
                stmt.setString(3, "Helldivers 2");
                stmt.setString(4, "/imagenes/helldiverPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/kingdomComeGrande.jpg");
                stmt.setString(3, "Kingdom Come: Deliverance II");
                stmt.setString(4, "/imagenes/kingdomComePequeno.jpg");
                stmt.setDouble(5, 5999);
                ...
                stmt.setString(2, "/imagenes/legoUndercoverGrande.jpg");
                stmt.setString(3, "LEGO CITY Undercover");
                stmt.setString(4, "/imagenes/legoUndercoverPequeno.jpg");
                stmt.setDouble(5, 2999);
                ...
                stmt.setString(2, "/imagenes/minecraftGrande.jpg");
                stmt.setString(3, "Minecraft");
                stmt.setString(4, "/imagenes/minecraftPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/outlastGrande.jpg");
                stmt.setString(3, "Outlast");
                stmt.setString(4, "/imagenes/outlastPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/payday2Grande.jpg");
                stmt.setString(3, "Pay Day 2");
                stmt.setString(4, "/imagenes/payday2Pequeno.jpg");
                stmt.setDouble(5, 999);
                ...
                stmt.setString(2, "/imagenes/r6Grande.jpg");
                stmt.setString(3, "Tom Clancy's Rainbow Six Siege");
                stmt.setString(4, "/imagenes/r6Pequeno.jpg");
                stmt.setDouble(5, 1999);
                ...
                stmt.setString(2, "/imagenes/rustGrande.jpg");
                stmt.setString(3, "Rust");
                stmt.setString(4, "/imagenes/rustPequeno.jpg");
                stmt.setDouble(5, 3999);
                ...
                stmt.setString(2, "/imagenes/seaofThievesGrande.jpg");
                stmt.setString(3, "Sea Of Thieves");
                stmt.setString(4, "/imagenes/seaofThievesPequeno.jpg");
                stmt.setDouble(5, 3999);
                ...
                stmt.setString(2, "/imagenes/skyrimGrande.jpg");
                stmt.setString(3, "The Elder Scrolls V: Skyrim");
                stmt.setString(4, "/imagenes/skyrimPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/spidermanGrande.jpg");
                stmt.setString(3, "Marvel's Spider-Man 2");
                stmt.setString(4, "/imagenes/spidermanPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/subnauticaGrande.jpg");
                stmt.setString(3, "Subnautica");
                stmt.setString(4, "/imagenes/subnauticaPequeno.jpg");
                stmt.setDouble(5, 2299);
                ...
                stmt.setString(2, "/imagenes/terrariaGrande.jpg");
                stmt.setString(3, "Terraria");
                stmt.setString(4, "/imagenes/terrariaPequeno.jpg");
                ...
                stmt.setString(2, "/imagenes/ultrakillGrande.jpg");
                stmt.setString(3, "UltraKill");
                stmt.setString(4, "/imagenes/ultrakillPequeno.jpg");
